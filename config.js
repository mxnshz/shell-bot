module.exports = {
  ...
  items: [
    ...
    {
      id: 1,
      name: 'Minimal+ 3 месяца',
      description: 'Выдаёт в инвентарь minimal+ подписку на 3 месяца',
      image:
        'https://cdn-icons.flaticon.com/png/512/2221/premium/2221265.png?token=exp=1656605184~hmac=831cfca53af62c298c4335706114a219',
      price: '65',
    },
    {
      id: 2,
      name: 'Minimal+ 6 месяца',
      description: 'Выдаёт в инвентарь minimal+ подписку на 6 месяцев',
      image:
        'https://cdn-icons.flaticon.com/png/512/2221/premium/2221265.png?token=exp=1656605184~hmac=831cfca53af62c298c4335706114a219',
      price: '85',
    },
    {
      id: 3,
      name: 'Minimal+ UNLIM',
      description: 'Выдаёт в инвентарь minimal+ подписку на нескончаемый срок',
      image:
        'https://cdn-icons.flaticon.com/png/512/2221/premium/2221265.png?token=exp=1656605184~hmac=831cfca53af62c298c4335706114a219',
      price: '105',
    },
    // Тулы
    {
      id: 4,
      name: 'Дубликатор',
      description: 'Выдаёт доступ к инструменту',
      image: 'https://cdn-icons-png.flaticon.com/512/627/627495.png',
      price: '40',
    },
    // Машины
    {
      id: 5,
      name: 'Дрифтовый набор',
      description: 'Выдаёт доступ к покупке машин из дрифтового набора',
      image: 'https://cdn-icons-png.flaticon.com/512/148/148924.png',
      price: '40',
    },
    {
      id: 6,
      name: 'Автомобильный номер',
      description: 'Позволяет выбрать себе понравившиеся автомобильный номер',
      image: 'https://cdn-icons-png.flaticon.com/512/149/149075.png',
      price: '25',
    },
    // Другое
    {
      id: 7,
      name: '+50 пропов к лимиту',
      description: 'Дополнительный лимит',
      image: 'https://cdn-icons-png.flaticon.com/512/148/148781.png',
      price: '25',
    },
    {
      id: 8,
      name: 'Говорилка',
      description: 'Придаёт к озвучке вами написанный текст на сервере',
      image: 'https://cdn-icons-png.flaticon.com/512/149/149046.png',
      price: '25',
    },
    {
      id: 9,
      name: 'Профессия организации',
      description: 'После покупки вас перенаправит к консультанту для создания профессии.',
      image: 'https://cdn-icons-png.flaticon.com/512/148/148905.png',
      price: '250',
    },
  ],
