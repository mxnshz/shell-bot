...
bot.embed = function ({ content }) {
  if (content == undefined)
    return console.error(`ERROR | Неверное использование функции, проверьте аргументы!`);

  let embed = new MessageEmbed().setColor(botconfig.color).setDescription(`**${content}**`);
  return embed;
};
